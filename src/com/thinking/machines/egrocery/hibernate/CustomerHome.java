 ...
 * @see com.thinking.machines.egrocery.hibernate.Customer
	...
	public Customer findById(java.lang.Integer id) {
		...
		try {
			Customer instance = (Customer) sessionFactory.getCurrentSession()
					.get("com.thinking.machines.egrocery.hibernate.Customer", id);
			if (instance == null) {
	...
	public List findByExample(Customer instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.thinking.machines.egrocery.hibernate.Customer").add(Example.create(instance))
					.list();
