 ...
 * @see com.thinking.machines.egrocery.hibernate.Item
...
public class ItemHome {
	...
	public Item findById(java.lang.Integer id) {
		...
		try {
			Item instance = (Item) sessionFactory.getCurrentSession()
					.get("com.thinking.machines.egrocery.hibernate.Item", id);
			if (instance == null) {
	...
	public List findByExample(Item instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.thinking.machines.egrocery.hibernate.Item").add(Example.create(instance))
					.list();
