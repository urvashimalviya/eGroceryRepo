 ...
 * @see com.thinking.machines.egrocery.hibernate.Category
	...
	public Category findById(int id) {
		...
		try {
			Category instance = (Category) sessionFactory.getCurrentSession()
					.get("com.thinking.machines.egrocery.hibernate.Category", id);
			if (instance == null) {
	...
	public List findByExample(Category instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.thinking.machines.egrocery.hibernate.Category").add(Example.create(instance))
					.list();
